...
jQuery(document).ready(function($) {
    ...
    $(function() {
        ...
        $(".showMeetButton").click(function(){
            $("#meetHues").slideDown();
        });

        $(".closeMeetButton").click(function(){
            $("#meetHues").hide();
        });
    });
    ...
    $(function() {
        ...
        $(window).scroll(function() {
            ...
            if (scroll >= 75) {
                stickyNav.removeClass("unactiveSticky").addClass("activateSticky");
            } else {
                stickyNav.removeClass("activateSticky").addClass("unactiveSticky");
            }
        });
    });
